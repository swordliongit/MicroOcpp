...
PZEM004Tv30 pzem1(Serial2,
                  16,
                  17,
                  0x07); // Don't forget to arrange spesific address
PZEM004Tv30 pzem2(Serial2,
                  16,
                  17,
                  0x08); // Don't forget to arrange spesific address
PZEM004Tv30 pzem3(Serial2,
                  16,
                  17,
                  0x09); // Don't forget to arrange spesific address

void read_Energy_Serial() {
    unsigned long currentMillis = millis();
    if (currentMillis - previousMillis_energy_serial_timer >=
        interval_energy_serial_timer) {
        ...
        if (isnan(voltage_1)) {
            ...
            if (voltage_1 > 200 && voltage_2 > 200 && voltage_3 > 200) {
                sensor_1_value =
                    (voltage_1 * current_1 + voltage_2 * current_2 +
                     voltage_3 * current_3) /
                    1000;
            }
            if (sensor_1_value < 0) {
            ...
            Serial.print(energy_1, 3);
            Serial.println("kWh");
            Serial.print("Frequency_1: ");
            Serial.print(frequency_1, 1);
            Serial.println("Hz");
            Serial.print("PF_1: ");
            Serial.println(pf_1);
            Serial.println("-------");
        ...
        if (isnan(voltage_2)) {
            ...
            Serial.print(energy_2, 3);
            Serial.println("kWh");
            Serial.print("Frequency_2: ");
            Serial.print(frequency_2, 1);
            Serial.println("Hz");
            Serial.print("PF_2: ");
            Serial.println(pf_2);
            Serial.println("-------");
        ...
        if (isnan(voltage_3)) {
            ...
            Serial.print(power_3);
            Serial.println("W");
            Serial.print("Energy_3: ");
            Serial.print(energy_3, 3);
            Serial.println("kWh");
            Serial.print("Frequency_3: ");
            Serial.print(frequency_3, 1);
            Serial.println("Hz");
            Serial.print("PF_3: ");
            Serial.println(pf_3);
            Serial.println("-------");
        ...
        if (voltage_1 > 200 && voltage_2 > 200 && voltage_3 > 200) {
            sensor_1_value = (voltage_1 * current_1 + voltage_2 * current_2 +
                              voltage_3 * current_3) /
                             1000;
        }
    }
